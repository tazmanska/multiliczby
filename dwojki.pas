...
uses
  ...
  Grids, StdCtrls, ComCtrls, Spin, Buttons,main, Gauges, Menus, XPMan;
...
procedure TForm10.wlacz_kontrolki(stan: boolean);
begin
  _okno.Enabled := stan;
...
procedure TForm10.KopiujdoZestaww1Click(Sender: TObject);
begin
