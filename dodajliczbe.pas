...
if nr_liczb=1 then form12.Caption:='Dodaj liczby I';
if nr_liczb=2 then form12.caption:='Dodaj liczby II';

end;

procedure TForm12.wybranych(ilosc: word);
begin
...
if nr_liczb=1 then ilosc_1:=help2 else ilosc_2:=help2;
close;
end;
